        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-md bg-white py-2 px-3 text-gray-700 shadow-sm ring-1 ring-gray-300 hover:bg-gray-50 focus:outline-offset-0"
            >
              <svg
