      ...
      <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-lg mx-auto md:max-w-none md:grid md:grid-cols-2 md:gap-8">
          ...
          <div className="mt-12 sm:mt-16 md:mt-0">
            {success ? (
              <div className="p-6 border border-green-200 rounded-md bg-green-50">
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-y-6">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      className="block w-full px-4 py-3 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    />
                  </div>
                </div>
                ...
                <div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="inline-flex items-center justify-center w-full px-6 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-400"
                  >
